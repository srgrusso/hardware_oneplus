...
public class DeviceExtras extends PreferenceFragment
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        // Headphone gain
        speakerCategory = speakerCategory | isFeatureSupported(context, R.bool.config_deviceSupportsHeadphoneGain);
        if (isFeatureSupported(context, R.bool.config_deviceSupportsHeadphoneGain)) {
            mHeadphoneGain = (HeadphoneGainPreference) findPreference(KEY_HEADPHONE_GAIN);
            if (mHeadphoneGain != null) {
                mHeadphoneGain.setEnabled(HeadphoneGainPreference.isSupported(getContext()));
            }
        }
        else {
            findPreference(KEY_HEADPHONE_GAIN).setVisible(false);
        }
        ...
        // Speaker gain
        speakerCategory = speakerCategory | isFeatureSupported(context, R.bool.config_deviceSupportsSpeakerGain);
        if (isFeatureSupported(context, R.bool.config_deviceSupportsSpeakerGain)) {
            mSpeakerGain = (SpeakerGainPreference) findPreference(KEY_SPEAKER_GAIN);
            if (mSpeakerGain != null) {
                mSpeakerGain.setEnabled(SpeakerGainPreference.isSupported(getContext()));
            }
        }
        else {
